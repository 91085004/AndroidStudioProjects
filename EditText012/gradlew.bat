...
<project version="4">
  ...
  <component name="ChangeListManager">
    <list default="true" id="266e3b41-12fc-4bd4-9d88-39e271fe4a95" name="Default" comment="" />
  ...
  <component name="FileEditorManager">
    <leaf SIDE_TABS_SIZE_LIMIT_KEY="300">
      <file leaf-file-name="MainActivity.java" pinned="false" current-in-tab="false">
        <entry file="file://$PROJECT_DIR$/app/src/main/java/com/example/palmdigital/chooseyourownadventurev01/MainActivity.java">
      ...
      <file leaf-file-name="BackyardActivity.jav